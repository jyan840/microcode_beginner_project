...
; yosys-smt2-witness {"offset": 0, "path": ["\\b"], "smtname": "b", "type": "blackbox", "width": 8}
...
; yosys-smt2-witness {"offset": 0, "path": ["\\a_i"], "smtname": "a_i", "type": "input", "width": 8}
...
(define-fun |test#2| ((state |test_s|)) (_ BitVec 32) (bvadd (concat #b000000000000000000000000 (|test#1| state)) #b00000000000000000000000000000001)) ; { $add$top.v:12$1_Y [31:8] \b_o }
; yosys-smt2-output b_o 8
(define-fun |test_n b_o| ((state |test_s|)) (_ BitVec 8) ((_ extract 7 0) (|test#2| state)))
